    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
                ...
                if (empty($fullname) || empty($email)) {
                    ...
                    try {
                        ...
                        if ($stmt->fetch()) {
                            ...
                            $stmt = $pdo->prepare("UPDATE users SET fullname = ?, email = ?, phone = ?, gender = ?, birthday = ?, updated_at = NOW() WHERE id = ?");
                            $stmt->execute([$fullname, $email, $phone, $gender, $birthday ?: null, $user_id]);
            ...
            case 'update_notifications':
                ...
                try {
                    // Kiểm tra và tạo bảng user_settings nếu chưa có
                    ...
                    $stmt = $pdo->prepare("INSERT INTO user_settings (user_id, email_notifications, assignment_reminders, grade_notifications, class_updates) 
                                          VALUES (?, ?, ?, ?, ?)
                    ...
                    $stmt->execute([$user_id, $email_notifications, $assignment_reminders, $grade_notifications, $class_updates]);
...
<head>
    ...
    <title>Cài đặt | EDUSERVICE</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="menu-container">
            <div class="menu-section">
                <div class="menu-header">Học tập</div>
                <div class="menu-items">
                    <div class="menu-item" onclick="window.location.href='trangchusaudn.php'">
                        <i class="fas fa-home"></i>
                        <span>Trang chủ</span>
                    </div>
                    <div class="menu-item" onclick="window.location.href='trangchusaudn.php#tasks'">
                        <i class="fas fa-book"></i>
                        <span>Nhiệm vụ</span>
                    </div>
                    <div class="menu-item" onclick="window.location.href='trangchusaudn.php#classes'">
            ...
            <div class="menu-section">
                ...
                <div class="menu-items">
                    <div class="menu-item" onclick="window.location.href='hoso.php'">
    ...
    <main class="main-container">
        <div class="settings-container">
            <a href="trangchusaudn.php" class="back-btn">
                <i class="fas fa-arrow-left"></i> Quay lại trang chủ
            </a>
            
            <div class="settings-header">
                <h1><i class="fas fa-cog"></i> Cài đặt tài khoản</h1>
                <p>Quản lý thông tin cá nhân và tùy chỉnh trải nghiệm của bạn</p>
            </div>
                        ...
                        <div class="avatar-preview-wrapper">
                            ...
                            <?php else: ?>
                                <div class="avatar-placeholder">
                                    <?php echo strtoupper(substr($user_info['fullname'] ?? 'U', 0, 1)); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <div class="toggle-group">
                                        ...
                                        <label class="toggle-switch">
                                            <input type="checkbox" name="assignment_reminders" <?php echo ($user_settings['assignment_reminders'] ?? 1) ? 'checked' : ''; ?>>
                                            <span class="toggle-slider"></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="toggle-group">
                                        <div class="toggle-info">
                                            ...
                                            <p>Nhận thông báo khi có điểm mới</p>
                                        </div>
                                        <label class="toggle-switch">
                                            <input type="checkbox" name="grade_notifications" <?php echo ($user_settings['grade_notifications'] ?? 1) ? 'checked' : ''; ?>>
                                            <span class="toggle-slider"></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="toggle-group">
                                        <div class="toggle-info">
                                            ...
                                            <p>Nhận thông báo khi có bài học mới hoặc thay đổi trong lớp</p>
                                        </div>
                                        <label class="toggle-switch">
    ...
    <script>
        ...
        function confirmDeleteAccount() {
            Swal.fire({
                ...
                text: 'Tất cả dữ liệu của bạn sẽ bị xóa vĩnh viễn. Hành động này không thể hoàn tác!',
                icon: 'warning',
